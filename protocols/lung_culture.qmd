...
1. Prepare Lung media:
    - Use DMEM/F12 HEPES
        - Without phenol red if doing fluoressence imaging.
	- Add Pen/Strep such that you have 10 U/ml penicillin and 10 µg/ml streptomycin.
		https://journals.biologists.com/dev/article/144/23/4328/19250
...
3. Culture
    ...
    - For long cultures, sterility is important. 
        -During dissection, sterilize tools before use
        -During chamber preperation, work in a TC hood

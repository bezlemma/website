...
9.  **Wash:** Wash 4 times with 500 µL TBST for 15 minutes each at RT on a shaker.
10. **Blocking:** Block with 500 µL for 1 hour at RT on a shaker. 
11. **Secondary Antibody Incubation:** Combine secondary antibodies with 500 µL blocking solution. Pipette gently to mix. 
    *   Note any volume alterations.
    *   **Do not vortex!**
...
13. **Wash** Perform 3 washes with TBST for 15 minutes each at RT.
    * Transfer to PBS for 15 minutes to wash off TBST.
14. **Dehydration/Clearing (Isopropanol or Methanol):** Titrate through Isopropanol series: 25%, 50%, 75%, 100% (15 minutes each step).
...
15. **Imaging Chamber Preparation:**
...
16. **Clearing (iso:BABB):** Place samples in the final container, add 1:1 iso:BABB. Position the samples if possible. Wait 5 minutes.
17. **Clearing (BABB):** Remove iso:BABB with a thin-tip pipette. Add 100% BABB. Position samples if visible.
18. **Mounting:** Seal the coverslip onto the washer, this is the trickiest bit.
...
19. **Imaging:** Image as soon as possible after clearing. DAPI signal fades over time, and bubbles can form in the sample holder.
